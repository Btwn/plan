...
GO
ALTER FUNCTION fnMFACuentaSaldoInicial (@Empresa varchar(5), @Ejercicio int, @Periodo int, @Cuenta varchar(20), @Moneda varchar(10), @Campo varchar(10))
RETURNS float
...
LEFT OUTER JOIN MFACuentasEspeciales C ON C.Cuenta=MFACtaSaldoEjercicio.Cuenta 
