...
GO
ALTER FUNCTION fnDIOTIVAImportacion(
@Mov							varchar(20),
@MovID							varchar(20),
@Empresa						varchar(5),
...
JOIN DIOTConceptoIVAImportacion WITH(NOLOCK) ON DIOTCxpDocumentoImportacion.Concepto = DIOTConceptoIVAImportacion.Concepto
