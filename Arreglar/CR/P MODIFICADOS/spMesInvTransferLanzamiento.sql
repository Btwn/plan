...
FROM PrevisionesConsumoMES pcm  WITH (NOLOCK)  
JOIN Art a  WITH (NOLOCK)  ON pcm.Hijo = a.Articulo
LEFT OUTER JOIN ArtDisponible ad WITH (NOLOCK)   ON ad.Empresa = @Empresa AND ad.Articulo = a.Articulo AND ad.Almacen = a.AlmMesComs
