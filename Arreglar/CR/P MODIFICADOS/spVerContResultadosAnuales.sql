...
JOIN Cta Rama WITH(NOLOCK) ON Cta.Rama = Rama.Cuenta
JOIN ContSubSaldo cc WITH(NOLOCK) ON Cta.cuenta = cc.Cuenta
...
IF @@FETCH_STATUS <> -2
BEGIN
UPDATE #ResultadoA SET Ingresos1  = (SELECT Sum(ISNULL(a.Cargos, 0.0)-ISNULL(a.Abonos, 0.0)) FROM Acum a WITH(NOLOCK) WHERE a.Rama = 'CONT' AND a.Cuenta = @CtaIngresos AND ISNULL(a.SubCuenta, '') = ISNULL(ISNULL(@CentroCostos, a.SubCuenta), '') AND ISNULL(a.Sucursal, 0) = ISNULL(ISNULL(@Sucursal, a.Sucursal), 0) AND ISNULL(a.UEN, 0) = ISNULL(ISNULL(@UEN, a.UEN), 0) AND ISNULL(a.Proyecto, '')  = ISNULL(ISNULL(@Proyecto, a.Proyecto), '') AND ISNULL(a.SubCuenta2, '')= ISNULL(ISNULL(@CentroCostos2, a.SubCuenta2), '') AND ISNULL(a.SubCuenta3, '')= ISNULL(ISNULL(@CentroCostos3, a.SubCuenta3), '') AND a.Ejercicio = b.Ejercicio1 AND a.Periodo <= @PeriodoX AND a.Moneda = @Moneda AND a.Empresa = @Empresa) FROM #ResultadoA b WHERE b.Ejercicio1 = @EjercicioX
UPDATE #ResultadoA SET Ingresos2  = (SELECT Sum(ISNULL(a.Cargos, 0.0)-ISNULL(a.Abonos, 0.0)) FROM Acum a WITH(NOLOCK) WHERE a.Rama = 'CONT' AND a.Cuenta = @CtaIngresos AND ISNULL(a.SubCuenta, '') = ISNULL(ISNULL(@CentroCostos, a.SubCuenta), '') AND ISNULL(a.Sucursal, 0) = ISNULL(ISNULL(@Sucursal, a.Sucursal), 0) AND ISNULL(a.UEN, 0) = ISNULL(ISNULL(@UEN, a.UEN), 0) AND ISNULL(a.Proyecto, '')  = ISNULL(ISNULL(@Proyecto, a.Proyecto), '') AND ISNULL(a.SubCuenta2, '')= ISNULL(ISNULL(@CentroCostos2, a.SubCuenta2), '') AND ISNULL(a.SubCuenta3, '')= ISNULL(ISNULL(@CentroCostos3, a.SubCuenta3), '') AND a.Ejercicio = b.Ejercicio2 AND a.Periodo <= @PeriodoX AND a.Moneda = @Moneda AND a.Empresa = @Empresa) FROM #ResultadoA b WHERE b.Ejercicio2 = @EjercicioX
UPDATE #ResultadoA SET Ingresos3  = (SELECT Sum(ISNULL(a.Cargos, 0.0)-ISNULL(a.Abonos, 0.0)) FROM Acum a WITH(NOLOCK) WHERE a.Rama = 'CONT' AND a.Cuenta = @CtaIngresos AND ISNULL(a.SubCuenta, '') = ISNULL(ISNULL(@CentroCostos, a.SubCuenta), '') AND ISNULL(a.Sucursal, 0) = ISNULL(ISNULL(@Sucursal, a.Sucursal), 0) AND ISNULL(a.UEN, 0) = ISNULL(ISNULL(@UEN, a.UEN), 0) AND ISNULL(a.Proyecto, '')  = ISNULL(ISNULL(@Proyecto, a.Proyecto), '') AND ISNULL(a.SubCuenta2, '')= ISNULL(ISNULL(@CentroCostos2, a.SubCuenta2), '') AND ISNULL(a.SubCuenta3, '')= ISNULL(ISNULL(@CentroCostos3, a.SubCuenta3), '') AND a.Ejercicio = b.Ejercicio3 AND a.Periodo <= @PeriodoX AND a.Moneda = @Moneda AND a.Empresa = @Empresa) FROM #ResultadoA b WHERE b.Ejercicio3 = @EjercicioX
UPDATE #ResultadoA SET Ingresos4  = (SELECT Sum(ISNULL(a.Cargos, 0.0)-ISNULL(a.Abonos, 0.0)) FROM Acum a WITH(NOLOCK) WHERE a.Rama = 'CONT' AND a.Cuenta = @CtaIngresos AND ISNULL(a.SubCuenta, '') = ISNULL(ISNULL(@CentroCostos, a.SubCuenta), '') AND ISNULL(a.Sucursal, 0) = ISNULL(ISNULL(@Sucursal, a.Sucursal), 0) AND ISNULL(a.UEN, 0) = ISNULL(ISNULL(@UEN, a.UEN), 0) AND ISNULL(a.Proyecto, '')  = ISNULL(ISNULL(@Proyecto, a.Proyecto), '') AND ISNULL(a.SubCuenta2, '')= ISNULL(ISNULL(@CentroCostos2, a.SubCuenta2), '') AND ISNULL(a.SubCuenta3, '')= ISNULL(ISNULL(@CentroCostos3, a.SubCuenta3), '') AND a.Ejercicio = b.Ejercicio4 AND a.Periodo <= @PeriodoX AND a.Moneda = @Moneda AND a.Empresa = @Empresa) FROM #ResultadoA b WHERE b.Ejercicio4 = @EjercicioX
UPDATE #ResultadoA SET Ingresos5  = (SELECT Sum(ISNULL(a.Cargos, 0.0)-ISNULL(a.Abonos, 0.0)) FROM Acum a WITH(NOLOCK) WHERE a.Rama = 'CONT' AND a.Cuenta = @CtaIngresos AND ISNULL(a.SubCuenta, '') = ISNULL(ISNULL(@CentroCostos, a.SubCuenta), '') AND ISNULL(a.Sucursal, 0) = ISNULL(ISNULL(@Sucursal, a.Sucursal), 0) AND ISNULL(a.UEN, 0) = ISNULL(ISNULL(@UEN, a.UEN), 0) AND ISNULL(a.Proyecto, '')  = ISNULL(ISNULL(@Proyecto, a.Proyecto), '') AND ISNULL(a.SubCuenta2, '')= ISNULL(ISNULL(@CentroCostos2, a.SubCuenta2), '') AND ISNULL(a.SubCuenta3, '')= ISNULL(ISNULL(@CentroCostos3, a.SubCuenta3), '') AND a.Ejercicio = b.Ejercicio5 AND a.Periodo <= @PeriodoX AND a.Moneda = @Moneda AND a.Empresa = @Empresa) FROM #ResultadoA b WHERE b.Ejercicio5 = @EjercicioX
UPDATE #ResultadoA SET Saldo1 = (SELECT Sum(ISNULL(a.Cargos, 0.0)-ISNULL(a.Abonos, 0.0)) FROM Acum a WITH(NOLOCK) WHERE a.Rama = 'CONT' AND a.Cuenta = b.Cuenta AND a.Ejercicio = b.Ejercicio1 AND ISNULL(a.SubCuenta, '') = ISNULL(b.SubCuenta, '') AND ISNULL(a.SubCuenta, '') = ISNULL(ISNULL(@CentroCostos, a.SubCuenta), '') AND ISNULL(a.Sucursal, 0) = ISNULL(ISNULL(@Sucursal, a.Sucursal), 0) AND ISNULL(a.UEN, 0) = ISNULL(ISNULL(@UEN, a.UEN), 0) AND ISNULL(a.Proyecto, '')  = ISNULL(ISNULL(@Proyecto, a.Proyecto), '') AND ISNULL(a.SubCuenta2, '')= ISNULL(ISNULL(@CentroCostos2, a.SubCuenta2), '') AND ISNULL(a.SubCuenta3, '')= ISNULL(ISNULL(@CentroCostos3, a.SubCuenta3), '') AND a.Moneda = @Moneda AND a.Periodo <= @PeriodoX AND a.Empresa = @Empresa) FROM #ResultadoA b WHERE b.Ejercicio1 = @EjercicioX
UPDATE #ResultadoA SET Saldo2 = (SELECT Sum(ISNULL(a.Cargos, 0.0)-ISNULL(a.Abonos, 0.0)) FROM Acum a WITH(NOLOCK) WHERE a.Rama = 'CONT' AND a.Cuenta = b.Cuenta AND a.Ejercicio = b.Ejercicio2 AND ISNULL(a.SubCuenta, '') = ISNULL(b.SubCuenta, '') AND ISNULL(a.SubCuenta, '') = ISNULL(ISNULL(@CentroCostos, a.SubCuenta), '') AND ISNULL(a.Sucursal, 0) = ISNULL(ISNULL(@Sucursal, a.Sucursal), 0) AND ISNULL(a.UEN, 0) = ISNULL(ISNULL(@UEN, a.UEN), 0) AND ISNULL(a.Proyecto, '')  = ISNULL(ISNULL(@Proyecto, a.Proyecto), '') AND ISNULL(a.SubCuenta2, '')= ISNULL(ISNULL(@CentroCostos2, a.SubCuenta2), '') AND ISNULL(a.SubCuenta3, '')= ISNULL(ISNULL(@CentroCostos3, a.SubCuenta3), '') AND a.Moneda = @Moneda AND a.Periodo <= @PeriodoX AND a.Empresa = @Empresa) FROM #ResultadoA b WHERE b.Ejercicio2 = @EjercicioX
UPDATE #ResultadoA SET Saldo3 = (SELECT Sum(ISNULL(a.Cargos, 0.0)-ISNULL(a.Abonos, 0.0)) FROM Acum a WITH(NOLOCK) WHERE a.Rama = 'CONT' AND a.Cuenta = b.Cuenta AND a.Ejercicio = b.Ejercicio3 AND ISNULL(a.SubCuenta, '') = ISNULL(b.SubCuenta, '') AND ISNULL(a.SubCuenta, '') = ISNULL(ISNULL(@CentroCostos, a.SubCuenta), '') AND ISNULL(a.Sucursal, 0) = ISNULL(ISNULL(@Sucursal, a.Sucursal), 0) AND ISNULL(a.UEN, 0) = ISNULL(ISNULL(@UEN, a.UEN), 0) AND ISNULL(a.Proyecto, '')  = ISNULL(ISNULL(@Proyecto, a.Proyecto), '') AND ISNULL(a.SubCuenta2, '')= ISNULL(ISNULL(@CentroCostos2, a.SubCuenta2), '') AND ISNULL(a.SubCuenta3, '')= ISNULL(ISNULL(@CentroCostos3, a.SubCuenta3), '') AND a.Moneda = @Moneda AND a.Periodo <= @PeriodoX AND a.Empresa = @Empresa) FROM #ResultadoA b WHERE b.Ejercicio3 = @EjercicioX
UPDATE #ResultadoA SET Saldo4 = (SELECT Sum(ISNULL(a.Cargos, 0.0)-ISNULL(a.Abonos, 0.0)) FROM Acum a WITH(NOLOCK) WHERE a.Rama = 'CONT' AND a.Cuenta = b.Cuenta AND a.Ejercicio = b.Ejercicio4 AND ISNULL(a.SubCuenta, '') = ISNULL(b.SubCuenta, '') AND ISNULL(a.SubCuenta, '') = ISNULL(ISNULL(@CentroCostos, a.SubCuenta), '') AND ISNULL(a.Sucursal, 0) = ISNULL(ISNULL(@Sucursal, a.Sucursal), 0) AND ISNULL(a.UEN, 0) = ISNULL(ISNULL(@UEN, a.UEN), 0) AND ISNULL(a.Proyecto, '')  = ISNULL(ISNULL(@Proyecto, a.Proyecto), '') AND ISNULL(a.SubCuenta2, '')= ISNULL(ISNULL(@CentroCostos2, a.SubCuenta2), '') AND ISNULL(a.SubCuenta3, '')= ISNULL(ISNULL(@CentroCostos3, a.SubCuenta3), '') AND a.Moneda = @Moneda AND a.Periodo <= @PeriodoX AND a.Empresa = @Empresa) FROM #ResultadoA b WHERE b.Ejercicio4 = @EjercicioX
UPDATE #ResultadoA SET Saldo5 = (SELECT Sum(ISNULL(a.Cargos, 0.0)-ISNULL(a.Abonos, 0.0)) FROM Acum a WITH(NOLOCK) WHERE a.Rama = 'CONT' AND a.Cuenta = b.Cuenta AND a.Ejercicio = b.Ejercicio5 AND ISNULL(a.SubCuenta, '') = ISNULL(b.SubCuenta, '') AND ISNULL(a.SubCuenta, '') = ISNULL(ISNULL(@CentroCostos, a.SubCuenta), '') AND ISNULL(a.Sucursal, 0) = ISNULL(ISNULL(@Sucursal, a.Sucursal), 0) AND ISNULL(a.UEN, 0) = ISNULL(ISNULL(@UEN, a.UEN), 0) AND ISNULL(a.Proyecto, '')  = ISNULL(ISNULL(@Proyecto, a.Proyecto), '') AND ISNULL(a.SubCuenta2, '')= ISNULL(ISNULL(@CentroCostos2, a.SubCuenta2), '') AND ISNULL(a.SubCuenta3, '')= ISNULL(ISNULL(@CentroCostos3, a.SubCuenta3), '') AND a.Moneda = @Moneda AND a.Periodo <= @PeriodoX AND a.Empresa = @Empresa) FROM #ResultadoA b WHERE b.Ejercicio5 = @EjercicioX
