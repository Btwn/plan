...
SELECT @XML = Plantilla, @Vista = Vista FROM CFDIRetencionXMLPlantilla WITH (NOLOCK) WHERE Version = @Version
/* Actualiza los Montos Gravados y Excentos en la vista CFDIRetencionCalc para que aparescan en el XML
de acuerdo a la tabla de configuraci�n CFDIRetSATRetencion y su concepto (Clave c�talogo SAT) */
