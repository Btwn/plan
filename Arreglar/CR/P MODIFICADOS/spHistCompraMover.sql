...
FROM CompraDPresupuestoEsp WITH(NOLOCK)
WHERE ID = @ID
...
FROM CompraDProrrateo WITH(NOLOCK)
WHERE ID = @ID
...
FROM CompraGastoDiverso WITH(NOLOCK)
WHERE ID = @ID
...
FROM CompraGastoDiversoArt WITH(NOLOCK)
WHERE ID = @ID
...
FROM CompraGastoDiversoD WITH(NOLOCK)
WHERE ID = @ID
...
FROM CompraGastoDiversoProv WITH(NOLOCK)
WHERE ID = @ID
...
FROM CompraGastoDiversoRef WITH(NOLOCK)
WHERE ID = @ID
...
FROM CompraGastoProrrateo WITH(NOLOCK)
WHERE ID = @ID
...
(ID, Renglon, RenglonSub, CuentaPresupuesto, Importe, Sucursal, SucursalOrigen)
SELECT ID, Renglon, RenglonSub, CuentaPresupuesto, Importe, Sucursal, SucursalOrigen
FROM VentaDPresupuestoEsp WITH(NOLOCK)
WHERE ID = @ID
