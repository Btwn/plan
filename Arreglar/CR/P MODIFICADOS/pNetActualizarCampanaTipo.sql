...
AS BEGIN
IF NOT EXISTS(SELECT 1 FROM CampanaTipo WITH(NOLOCK) WHERE CampanaTipo = ISNULL(@CampanaTipo,''))
...
ELSE
UPDATE CampanaTipo WITH(ROWLOCK) SET CampanaTipo = @CampanaTipo, ParaProspectos = 1 WHERE CampanaTipo = ISNULL(@CampanaTipo,'')
