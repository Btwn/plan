...
FROM Cxp a WITH (NOLOCK) 
JOIN CxpD b WITH (NOLOCK)  ON a.ID = b.ID
JOIN MovTipo mtx WITH (NOLOCK)  ON mtx.Mov = a.Mov AND mtx.Modulo = 'CXP' AND mtx.Clave = 'CXP.P'
JOIN CxpAplica h WITH (NOLOCK)  ON b.Aplica = h.Mov AND b.AplicaID = h.MovID AND h.Empresa = @Empresa
JOIN Dinero e  WITH (NOLOCK) ON e.CtaDinero = a.DineroCtaDinero AND a.Dinero = e.Mov AND a.DineroID = e.MovID
JOIN MovTipo mt2  WITH (NOLOCK) ON mt2.Mov = e.Mov AND mt2.Modulo = 'DIN' AND mt2.Clave IN ('DIN.CH', 'DIN.CHE', 'DIN.E')
JOIN Prov p  WITH (NOLOCK) ON a.Proveedor = p.Proveedor
JOIN Cxp x WITH (NOLOCK)  ON b.Aplica = x.Mov AND b.AplicaID = x.MovID
JOIN Gasto y  WITH (NOLOCK)  ON x.Origen = y.Mov AND x.OrigenID = y.MovID
JOIN GastoD z WITH (NOLOCK)  ON y.ID = z.ID
LEFT OUTER JOIN Concepto g  WITH (NOLOCK) ON z.Concepto = g.Concepto AND g.Modulo = 'GAS'
JOIN MovTipo mt3 WITH (NOLOCK)  ON mt3.Mov = y.Mov AND mt3.Modulo = 'GAS' AND mt3.Clave = 'GAS.G'
JOIN MovTipo mt4 WITH (NOLOCK)  ON mt4.Mov = b.Aplica AND mt4.Modulo = 'CXP' AND mt4.Clave IN ('CXP.AA','CXP.AF','CXP.D','CXP.DA','CXP.F')
WHERE
...
JOIN CxpD b WITH (NOLOCK)  ON c.ID = b.ID
JOIN MovTipo mty WITH (NOLOCK)  ON mty.Mov = c.Mov AND mty.Modulo = 'CXP' AND mty.Clave = 'CXP.ANC'
JOIN MovFlujo w  WITH (NOLOCK) ON w.DMov = c.Mov AND w.DMovID = c.MovID AND w.OModulo = 'CXP'
JOIN Cxp a  WITH (NOLOCK) ON w.OMov = a.Mov AND w.OMovID = a.MovID AND w.DModulo = 'CXP'
JOIN MovTipo mtx WITH (NOLOCK)  ON mtx.Mov = a.Mov AND mtx.Modulo = 'CXP' AND mtX.Clave = 'CXP.A'
JOIN CxpAplica h  WITH (NOLOCK) ON c.Mov = h.Mov AND c.MovID = h.MovID AND h.Empresa = @Empresa
JOIN Cxp x  WITH (NOLOCK) ON b.Aplica = x.Mov AND b.AplicaID = x.MovID
JOIN Gasto y  WITH (NOLOCK) ON x.Origen = y.Mov AND x.OrigenID = y.MovID
JOIN GastoD z  WITH (NOLOCK) ON y.ID = z.ID
LEFT OUTER JOIN Concepto g  WITH (NOLOCK) ON z.Concepto = g.Concepto AND g.Modulo = 'GAS'
...
JOIN Prov p WITH (NOLOCK)  ON a.Proveedor = p.Proveedor
JOIN Cxp x  WITH (NOLOCK) ON b.Aplica = x.Mov AND b.AplicaID = x.MovID
JOIN CxpD w WITH (NOLOCK)  ON x.ID = w.ID
JOIN Cxp v WITH (NOLOCK)  ON v.Mov = w.Aplica AND v.MovID = w.AplicaID
JOIN Gasto y  WITH (NOLOCK) ON v.Origen = y.Mov AND v.OrigenID = y.MovID
JOIN GastoD z  WITH (NOLOCK) ON y.ID = z.ID
LEFT OUTER JOIN Concepto g  WITH (NOLOCK) ON z.Concepto = g.Concepto AND g.Modulo = 'GAS'
JOIN MovTipo mt3  WITH (NOLOCK) ON mt3.Mov = y.Mov AND mt3.Modulo = 'GAS' AND mt3.Clave = 'GAS.G'
JOIN MovTipo mt4  WITH (NOLOCK) ON mt4.Mov = b.Aplica AND mt4.Modulo = 'CXP' AND mt4.Clave IN ('CXP.AA','CXP.AF','CXP.D','CXP.DA','CXP.F')
...
JOIN CxpAplica h  WITH (NOLOCK) ON c.Mov = h.Mov AND c.MovID = h.MovID AND h.Empresa = @Empresa
JOIN Cxp x  WITH (NOLOCK) ON b.Aplica = x.Mov AND b.AplicaID = x.MovID
JOIN CxpD j  WITH (NOLOCK) ON x.ID = j.ID
JOIN Cxp k WITH (NOLOCK)  ON k.Mov = j.Aplica AND k.MovID = j.AplicaID
JOIN Gasto y  WITH (NOLOCK) ON x.Origen = y.Mov AND x.OrigenID = y.MovID
JOIN GastoD z WITH (NOLOCK)  ON y.ID = z.ID
LEFT OUTER JOIN Concepto g  WITH (NOLOCK) ON z.Concepto = g.Concepto AND g.Modulo = 'GAS'
JOIN MovTipo mt3 WITH (NOLOCK)  ON mt3.Mov = y.Mov AND mt3.Modulo = 'GAS' AND mt3.Clave = 'GAS.G'
...
JOIN Prov p  WITH (NOLOCK) ON a.Proveedor = p.Proveedor
JOIN Cxp x  WITH (NOLOCK) ON b.Aplica = x.Mov AND b.AplicaID = x.MovID
JOIN Compra y WITH (NOLOCK)  ON x.Origen = y.Mov AND x.OrigenID = y.MovID
JOIN CompraD z WITH (NOLOCK)  ON y.ID = z.ID
JOIN Art g  WITH (NOLOCK) ON z.Articulo = g.Articulo
JOIN MovTipo mt3  WITH (NOLOCK) ON mt3.Mov = y.Mov AND mt3.Modulo = 'COMS' AND mt3.Clave IN ('COMS.F', 'COMS.FL', 'COMS.EG')
JOIN MovImpuesto m  WITH (NOLOCK) ON y.ID = m.ModuloID AND m.Modulo = 'COMS' AND ((ROUND(m.SubTotal, 2) = ROUND(y.Importe, 2)) OR (ROUND(m.SubTotal+m.Importe1+m.Importe2, 2) = ROUND(y.Importe, 2)))
JOIN MovTipo mt4  WITH (NOLOCK) ON mt4.Mov = b.Aplica AND mt4.Modulo = 'CXP' AND mt4.Clave IN ('CXP.AA','CXP.AF','CXP.D','CXP.DA','CXP.F')
WHERE
e.FechaConciliacion BETWEEN @FechaD AND @FechaA
AND a.Estatus = 'CONCLUIDO'
...
JOIN MovTipo mt3  WITH (NOLOCK) ON mt3.Mov = y.Mov AND mt3.Modulo = 'COMS' AND mt3.Clave IN ('COMS.F', 'COMS.FL', 'COMS.EG')
JOIN Dinero e WITH (NOLOCK)  ON e.CtaDinero = a.DineroCtaDinero AND a.Dinero = e.Mov AND a.DineroID = e.MovID
JOIN MovTipo mt2  WITH (NOLOCK) ON mt2.Mov = e.Mov AND mt2.Modulo = 'DIN' AND mt2.Clave IN ('DIN.CH', 'DIN.CHE')
JOIN Prov p  WITH (NOLOCK) ON a.Proveedor = p.Proveedor
JOIN MovImpuesto m WITH (NOLOCK) ON y.ID = m.ModuloID AND m.Modulo = 'COMS' AND ((ROUND(m.SubTotal, 2) = ROUND(y.Importe, 2)) OR (ROUND(m.SubTotal+m.Importe1+m.Importe2, 2) = ROUND(y.Importe, 2)))
JOIN MovTipo mt4  WITH (NOLOCK) ON mt4.Mov = b.Aplica AND mt4.Modulo = 'CXP' AND mt4.Clave IN ('CXP.AA','CXP.AF','CXP.D','CXP.DA','CXP.F')
WHERE
...
FROM Cxp a WITH (NOLOCK) 
JOIN CxpD b WITH (NOLOCK)  ON a.ID = b.ID
JOIN MovTipo mt  WITH (NOLOCK) ON a.Mov = mt.Mov AND mt.Modulo = 'CXP' AND mt.Clave IN ('CXP.FAC', 'CXP.DAC')
JOIN CxpAplica h  WITH (NOLOCK) ON b.Aplica = h.Mov AND b.AplicaID = h.MovID AND h.Empresa = @Empresa
JOIN Cxp x  WITH (NOLOCK) ON b.Aplica = x.Mov AND b.AplicaID = x.MovID
JOIN Gasto y  WITH (NOLOCK) ON x.Origen = y.Mov AND x.OrigenID = y.MovID
JOIN GastoD z  WITH (NOLOCK) ON y.ID = z.ID
JOIN Prov p  WITH (NOLOCK) ON y.Acreedor = p.Proveedor
LEFT OUTER JOIN Concepto g  WITH (NOLOCK) ON z.Concepto = g.Concepto AND g.Modulo = 'GAS'
JOIN MovTipo mt3 WITH (NOLOCK)  ON mt3.Mov = y.Mov AND mt3.Modulo = 'GAS' AND mt3.Clave = 'GAS.G'
...
FROM Cxp a WITH (NOLOCK) 
JOIN CxpD b  WITH (NOLOCK) ON a.ID = b.ID
JOIN MovTipo mt  WITH (NOLOCK) ON a.Mov = mt.Mov AND mt.Modulo = 'CXP' AND mt.Clave IN ('CXP.NET')
JOIN CxpAplica h  WITH (NOLOCK) ON b.Aplica = h.Mov AND b.AplicaID = h.MovID AND h.Empresa = @Empresa
JOIN Prov p WITH (NOLOCK)  ON a.Proveedor = p.Proveedor
JOIN Cxp x  WITH (NOLOCK) ON b.Aplica = x.Mov AND b.AplicaID = x.MovID
JOIN Compra y  WITH (NOLOCK) ON x.Origen = y.Mov AND x.OrigenID = y.MovID
JOIN CompraD z WITH (NOLOCK)  ON y.ID = z.ID
JOIN Art g  WITH (NOLOCK) ON z.Articulo = g.Articulo
JOIN MovTipo mt3  WITH (NOLOCK) ON mt3.Mov = y.Mov AND mt3.Modulo = 'COMS' AND mt3.Clave = 'COMS.F'
JOIN MovImpuesto m  WITH (NOLOCK) ON y.ID = m.ModuloID AND m.Modulo = 'COMS' AND ((ROUND(m.SubTotal, 2) = ROUND(y.Importe, 2)) OR (ROUND(m.SubTotal+m.Importe1+m.Importe2, 2) = ROUND(y.Importe, 2)))
WHERE a.Estatus = 'CONCLUIDO'
AND a.FechaEmision BETWEEN @FechaD AND @FechaA
AND x.Estatus IN ('PENDIENTE', 'CONCLUIDO')
...
FROM Gasto a WITH (NOLOCK) 
JOIN GastoD b  WITH (NOLOCK) ON a.ID = b.ID
LEFT OUTER JOIN Concepto g WITH (NOLOCK)  ON b.Concepto = g.Concepto AND g.Modulo = 'GAS'
JOIN Prov p  WITH (NOLOCK) ON p.Proveedor = b.AcreedorRef
JOIN MovTipo mt WITH (NOLOCK)  ON mt.Mov = a.Mov AND mt.Modulo = 'GAS' AND mt.Clave IN ('GAS.CCH', 'GAS.C', 'GAS.CB')
WHERE
a.Estatus = 'CONCLUIDO'
...
LEFT OUTER JOIN Concepto g WITH (NOLOCK)  ON b.Concepto = g.Concepto AND g.Modulo = 'GAS'
JOIN Prov p  WITH (NOLOCK) ON p.Proveedor = b.AcreedorRef
JOIN MovTipo mt WITH (NOLOCK)  ON mt.Mov = a.Mov AND mt.Modulo = 'GAS' AND mt.Clave = 'GAS.GTC'
WHERE
a.Estatus = 'CONCLUIDO'
AND b.Fecha BETWEEN @FechaD AND @FechaA
AND a.Empresa = @Empresa
AND (SELECT ROUND(AVG(Pagado), 0) FROM PagadoAux WITH (NOLOCK) WHERE ModuloID = a.ID) = 100.0
INSERT IVADeclaradoInicial (
Estacion,  Empresa,   Proveedor,  RFC,   Nombre,   Mov,   MovID,   TipoOperacion,   Descripcion,
Importe, Impuesto, Impuesto15, Impuesto10, ImpuestoValidar, IvaOExento, PorcentajeDeducible)
...
JOIN GastoD b  WITH (NOLOCK) ON a.ID = b.ID
LEFT OUTER JOIN Concepto g WITH (NOLOCK)  ON b.Concepto = g.Concepto AND g.Modulo = 'GAS'
JOIN Prov p  WITH (NOLOCK) ON p.Proveedor = a.Acreedor
WHERE
...
JOIN CompraD z WITH (NOLOCK)  ON y.ID = z.ID
JOIN Art g WITH (NOLOCK)  ON z.Articulo = g.Articulo
JOIN MovTipo mt3 WITH (NOLOCK)  ON mt3.Mov = y.Mov AND mt3.Modulo = 'COMS' AND mt3.Clave IN ('COMS.EI')
JOIN MovImpuesto m  WITH (NOLOCK) ON y.ID = m.ModuloID AND m.Modulo = 'COMS' AND ((ROUND(m.SubTotal, 2) = ROUND(y.Importe, 2)) OR (ROUND(m.SubTotal+m.Importe1+m.Importe2, 2) = ROUND(y.Importe, 2)))
...
AND x.Empresa = @Empresa
AND y.Empresa = @Empresa
SELECT * FROM IVADeclaradoInicial WITH (NOLOCK)  WHERE Estacion = @Estacion ORDER BY Proveedor, Mov, MovID
END
