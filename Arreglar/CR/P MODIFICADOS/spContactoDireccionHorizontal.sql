...
FROM  ContactoDireccion d WITH (NOLOCK)
WHERE  d.ID = 1
AND  Estacion = @Estacion
UPDATE ContactoDireccionHorizontal WITH (ROWLOCK) SET Direccion2 = d.Direccion
FROM ContactoDireccionHorizontal r JOIN ContactoDireccion d WITH (NOLOCK)
ON d.ContactoTipo = r.ContactoTipo AND d.Contacto = r.Contacto
WHERE d.ID = 2
UPDATE ContactoDireccionHorizontal WITH (ROWLOCK) SET Direccion3 = d.Direccion
FROM ContactoDireccionHorizontal r JOIN ContactoDireccion d WITH (NOLOCK)
ON d.ContactoTipo = r.ContactoTipo AND d.Contacto = r.Contacto
WHERE d.ID = 3
UPDATE ContactoDireccionHorizontal WITH (ROWLOCK) SET Direccion4 = d.Direccion
FROM ContactoDireccionHorizontal r JOIN ContactoDireccion d WITH (NOLOCK)
ON d.ContactoTipo = r.ContactoTipo AND d.Contacto = r.Contacto
WHERE d.ID = 4
UPDATE ContactoDireccionHorizontal WITH (ROWLOCK) SET Direccion5 = d.Direccion
FROM ContactoDireccionHorizontal r JOIN ContactoDireccion d WITH (NOLOCK)
ON d.ContactoTipo = r.ContactoTipo AND d.Contacto = r.Contacto
WHERE d.ID = 5
UPDATE ContactoDireccionHorizontal WITH (ROWLOCK) SET Direccion6 = d.Direccion
FROM ContactoDireccionHorizontal r JOIN ContactoDireccion d WITH (NOLOCK)
ON d.ContactoTipo = r.ContactoTipo AND d.Contacto = r.Contacto
WHERE d.ID = 6
UPDATE ContactoDireccionHorizontal WITH (ROWLOCK) SET Direccion7 = d.Direccion
FROM ContactoDireccionHorizontal r JOIN ContactoDireccion d WITH (NOLOCK)
ON d.ContactoTipo = r.ContactoTipo AND d.Contacto = r.Contacto
WHERE d.ID = 7
UPDATE ContactoDireccionHorizontal WITH (ROWLOCK) SET Direccion8 = d.Direccion
FROM ContactoDireccionHorizontal r JOIN ContactoDireccion d WITH (NOLOCK)
ON d.ContactoTipo = r.ContactoTipo AND d.Contacto = r.Contacto
WHERE d.ID = 8
END
