...
FROM CuentasContables a WITH (NOLOCK) 
left join CuentaRubro b WITH (NOLOCK)  on a.CuentaContable=b.CuentaContable
left join cuentasretenciones cr  WITH (NOLOCK) on a.CuentaContable = cr.CuentaContable
END
