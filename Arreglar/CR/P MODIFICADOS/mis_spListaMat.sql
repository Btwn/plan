...
FROM ArtMaterial WITH(NOLOCK)
JOIN Art WITH(NOLOCK) ON ArtMaterial.Material=Art.Articulo
LEFT OUTER JOIN ArtCosto WITH(NOLOCK) ON ArtMaterial.Material = ArtCosto.Articulo AND ArtCosto.Empresa = @Empresa
...
ArtCosto.UltimoCosto
FROM ArtMaterial WITH(NOLOCK)
JOIN Art Producto WITH(NOLOCK) ON ArtMaterial.Articulo=Producto.Articulo
LEFT OUTER JOIN ArtCosto WITH(NOLOCK) ON ArtMaterial.Articulo = ArtCosto.Articulo AND ArtCosto.Empresa = @Empresa
