...
SELECT @DatosXMl = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(@DatosXMl, '�', 'a'), '�', 'e'), '�', 'i'), '�', 'o'), '�', 'u'), '�', 'u'), '�', 'n'), 'a', 'A'), '�', 'E'), 'S', 'I'), '�', 'O'), '�', 'U'), '�', 'U'), '�', 'N'),'''','''''')
IF @Ok is NULL
BEGIN
BEGIN TRY
...
BEGIN
SELECT @OK = 71651
SELECT @OkRef = Descripcion FROM MensajeCFDI WITH(NOLOCK) WHERE Mensaje = @EstatusCancelacion
END
END
END
END
