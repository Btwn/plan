...
LEFT OUTER JOIN Saldo s WITH(NOLOCK) ON Cta.Cuenta = s.Cuenta AND s.Rama = @Modulo AND s.Empresa = @Empresa AND s.Moneda = ISNULL(@MonedaEspecifica, s.Moneda)
JOIN ListaD WITH(NOLOCK) ON Cta.Cuenta = ListaD.Cuenta
LEFT OUTER JOIN ListaGrupo lg WITH(NOLOCK) ON ListaD.Grupo = lg.Grupo
LEFT OUTER JOIN ListaGrupo lsg WITH(NOLOCK) ON ListaD.SubGrupo = lsg.Grupo
...
FROM CentroCostos cc WITH(NOLOCK)
LEFT OUTER JOIN Saldo s WITH(NOLOCK) ON cc.CentroCostos = s.Cuenta AND s.Rama = @Modulo AND s.Empresa = @Empresa AND s.Moneda = ISNULL(@MonedaEspecifica, s.Moneda)
WHERE cc.Rama = @Rama
...
FROM CentroCostos2 cc WITH(NOLOCK)
LEFT OUTER JOIN Saldo s WITH(NOLOCK) ON cc.CentroCostos2 = s.Cuenta AND s.Rama = @Modulo AND s.Empresa = @Empresa AND s.Moneda = ISNULL(@MonedaEspecifica, s.Moneda)
WHERE cc.Rama = @Rama
...
FROM CentroCostos3 cc WITH(NOLOCK)
LEFT OUTER JOIN Saldo s WITH(NOLOCK) ON cc.CentroCostos3 = s.Cuenta AND s.Rama = @Modulo AND s.Empresa = @Empresa AND s.Moneda = ISNULL(@MonedaEspecifica, s.Moneda)
WHERE cc.Rama = @Rama
