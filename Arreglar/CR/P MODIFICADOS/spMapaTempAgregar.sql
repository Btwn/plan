...
LEFT OUTER JOIN CtaSituacion s  WITH (NOLOCK) ON s.Rama = 'CXC' AND s.Situacion = Cte.Situacion
LEFT OUTER JOIN Color c  WITH (NOLOCK) ON s.Color = c.Color
...
LEFT OUTER JOIN CtaSituacion s  WITH (NOLOCK) ON s.Rama = 'CXP' AND s.Situacion = Prov.Situacion
LEFT OUTER JOIN Color c WITH (NOLOCK)  ON s.Color = c.Color
...
LEFT OUTER JOIN CtaSituacion s  WITH (NOLOCK) ON s.Rama = 'CXP' AND s.Situacion = Personal.Situacion
LEFT OUTER JOIN Color c  WITH (NOLOCK) ON  s.Color = c.Color
