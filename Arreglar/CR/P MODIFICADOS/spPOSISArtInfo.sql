...
FROM ArtDisponible a WITH (NOLOCK) JOIN Alm alm WITH (NOLOCK) ON a.Almacen=Alm.Almacen
...
FROM ArtReservado a WITH (NOLOCK) LEFT OUTER JOIN Alm Alm WITH (NOLOCK) ON a.Almacen=Alm.Almacen
WHERE a.Articulo = @Articulo
