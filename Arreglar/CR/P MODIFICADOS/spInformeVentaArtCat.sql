...
GO
ALTER PROCEDURE spInformeVentaArtCat
@EstacionTrabajo		int
...
'Empresa'           = v.Empresa,
'Moneda'            = v.Moneda,
'Categoria'         = CASE WHEN ISNULL(a.Categoria,'(Sin Categor�a)') = '' THEN '(Sin Categor�a)' ELSE ISNULL(a.Categoria,'(Sin Categor�a)') END,
...
'Estacion'			= @EstacionTrabajo,
'Moneda2'           = v.Moneda,
'Categoria'         = CASE WHEN ISNULL(a.Categoria,'') = '' THEN '(Sin Categor�a)' ELSE SUBSTRING(a.Categoria,1, 30) END,
'ImporteTotal'      = SUM(v.ImporteTotal*mt.Factor),
