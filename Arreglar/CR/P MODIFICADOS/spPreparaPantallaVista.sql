...
DECLARE
@IDMovilVista INT
IF NOT EXISTS(SELECT * FROM MovilPantallaVista WITH (NOLOCK) WHERE Empresa = @Empresa AND Pantalla = 'Clientes')
BEGIN
SET @IDMovilVista = 0
...
END
END
IF NOT EXISTS(SELECT * FROM MovilPantallaVista WITH (NOLOCK) WHERE Empresa = @Empresa AND Pantalla = 'Articulos')
BEGIN
SET @IDMovilVista = 0
...
END
END
IF NOT EXISTS(SELECT * FROM MovilPantallaVista WITH (NOLOCK) WHERE Empresa = @Empresa AND Pantalla = 'Cobros')
BEGIN
SET @IDMovilVista = 0
