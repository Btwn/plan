...
0, @InfoDesglosar
FROM CxpInfo  WITH(NOLOCK) JOIN Prov
 WITH(NOLOCK) ON CxpInfo.Proveedor = Prov.Proveedor LEFT OUTER JOIN Cxp
 WITH(NOLOCK) ON Cxp.Empresa = CxpInfo.Empresa AND Cxp.Mov = CxpInfo.Mov AND Cxp.MovID = CxpInfo.MovID JOIN Empresa
 WITH(NOLOCK) ON Empresa.Empresa = CxpInfo.Empresa JOIN EmpresaCfg
...
1
FROM CxpInfo  WITH(NOLOCK) JOIN Prov
 WITH(NOLOCK) ON CxpInfo.Proveedor = Prov.Proveedor JOIN Cxp
 WITH(NOLOCK) ON Cxp.Empresa = CxpInfo.Empresa AND Cxp.Mov = CxpInfo.Mov AND Cxp.MovID = CxpInfo.MovID JOIN Empresa
 WITH(NOLOCK) ON Empresa.Empresa = CxpInfo.Empresa JOIN EmpresaCfg
 WITH(NOLOCK) ON EmpresaCfg.Empresa = Empresa.Empresa
WHERE CxpInfo.Empresa = @Empresa
...
FROM CxpInfo  WITH(NOLOCK) JOIN Prov
 WITH(NOLOCK) ON CxpInfo.Proveedor = Prov.Proveedor LEFT OUTER JOIN Cxp
 WITH(NOLOCK) ON Cxp.Empresa = CxpInfo.Empresa AND Cxp.Mov = CxpInfo.Mov AND Cxp.MovID = CxpInfo.MovID LEFT OUTER JOIN Empresa
 WITH(NOLOCK) ON Empresa.Empresa = CxpInfo.Empresa JOIN EmpresaCfg
 WITH(NOLOCK) ON EmpresaCfg.Empresa = Empresa.Empresa
WHERE CxpInfo.Empresa = @Empresa
AND CxpInfo.Proveedor BETWEEN @ProveedorD AND @ProveedorA
