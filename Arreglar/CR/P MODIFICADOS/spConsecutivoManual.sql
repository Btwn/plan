...
IF @ConsecutivoPorEmpresa   = 'GRUPO' SELECT @Empresa = Clave FROM EmpresaGrupo WITH (NOLOCK) , Empresa WITH (NOLOCK)  WHERE EmpresaGrupo.Grupo = Empresa.Grupo AND Empresa.Empresa = @Empresa
