...
GO
ALTER PROCEDURE spInformeCompraArtCat
@EstacionTrabajo		int
...
'Empresa'           = c.Empresa,
'Moneda'            = c.Moneda,
'Categoria'         = CASE WHEN ISNULL(a.Categoria,'') = '' THEN '(Sin Categor�a)' ELSE a.Categoria END,
...
FROM Art a
 WITH(NOLOCK) JOIN CompraTCalc c  WITH(NOLOCK) ON a.Articulo = c.Articulo
