...
GO
ALTER PROCEDURE spPlanDemandaDay
@Estacion		int,
@Empresa		char(5),
@Articulo		char(20),
@Almacen		char(10),
...
GROUP BY e.ID, e.Mov, e.MovID, d.Articulo, ISNULL(d.SubCuenta, ''), d.Almacen, CASE WHEN d.FechaRequerida < @Hoy THEN -1 ELSE ISNULL(DATEDIFF(Day, @Hoy, d.FechaRequerida), 0) END
