...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			IF LEN(@Recibo) > 35
				SELECT @Ok = 10010
					  ,@OkRef = 'CFD - Recibo Excede Tama_켹 Maximo 35'
			...
			IF LEN(@DepartamentoClave) > 35
				SELECT @Ok = 10010
					  ,@OkRef = 'CFD - Clave Departamento Cliente Excede Tama_켹 Maximo 35'
		...
		BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					IF LEN(@EAN13) > 14
						SELECT @Ok = 10010
							  ,@OkRef = 'CFD - Excede Tama_켹 Caracteres 14'
