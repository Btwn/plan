...
IF EXISTS(SELECT * FROM MovTipoObligacionFiscal WHERE Modulo = @Modulo AND Mov = @Mov) SELECT @ObligacionFiscalEspecifica = 1 ELSE SELECT @ObligacionFiscalEspecifica = 0  
