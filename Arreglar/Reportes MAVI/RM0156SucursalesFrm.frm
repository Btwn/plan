[Forma]
Clave=RM0156SucursalesFrm
Nombre=<T>Sucursales<T>
Icono=359
Modulos=(Todos)
...
IconosNombre=RM0156SucursalesVis:Sucursal
[Vista.Nombre]
Carpeta=Vista
Clave=Nombre
Editar=S
...
Activo=S
Visible=S
Expresion=Asigna(Mavi.RM0156Sucursal,SQL(<T>Exec SP_MaviCuentaEstacionUEN <T>+EstacionTrabajo+<T>,2<T>))<BR>SQL(<T>Exec SP_MaviCuentaEstacionUEN <T>+EstacionTrabajo+<T>,2<T>)
