[Forma]
Clave=RM0185MaviVentPorCelulasInstitucionesFrm
Nombre=RM0185 Reporte de Ventas por Institución
Icono=0
Modulos=(Todos)
...
PosicionSec1=54
PosicionSec2=54
ExpresionesAlMostrar=Asigna(Info.FechaD,nulo)<BR>Asigna(Info.FechaA,nulo)<BR>ASIGNA(INFO.DESGLOSAR,<T>Si<T>)<BR>ASIGNA(Mavi.gerenciaVI,<T><T>)<BR>ASIGNA(Mavi.DIVIDivisiones,<T><T>)<BR>ASIGNA(Mavi.celulaVI,<T><T>)
[(variables)]
Estilo=Ficha
Clave=(variables)
PermiteEditar=S
...
ListaEnCaptura=Info.FechaD<BR>Info.FechaA<BR>Mavi.GerenciaVI<BR>Mavi.DIVIDivisiones<BR>Mavi.CelulaVI<BR>Info.Desglosar
CarpetaVisible=S
