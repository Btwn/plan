...
VentanaEscCerrar=S
ExpresionesAlMostrar=Asigna(Mavi.CanalUEN,nulo)<BR>Asigna(Mavi.ArtGrupLigFam, <T>MERCANCIA DE LINEA<T>)<BR>Asigna(Info.UEN,nulo)<BR>Asigna(Mavi.ArtFamLigLin,nulo)<BR>Asigna(Mavi.ArtLinLigLin,nulo)<BR>Asigna(Mavi.ArticuloD,nulo)<BR>Asigna(Mavi.ArticuloA,nulo)<BR>Asigna(Mavi.MesD, MesNombre(Mes(Hoy)))<BR>Asigna(Info.FechaD,Nulo)<BR>Asigna(Info.FechaA,Nulo)<BR>Asigna(Info.ProveedorD,Nulo)<BR>Asigna(Info.ProveedorA,Nulo)
[(Variables)]
Estilo=Ficha
Clave=(Variables)
PermiteEditar=S
...
ListaEnCaptura=Info.UEN<BR>Mavi.CanalUEN<BR>Mavi.ArtFamLigLin<BR>Mavi.ArtLinLigLin<BR>Mavi.ArticuloD<BR>Mavi.ArticuloA<BR>Info.ProveedorD<BR>Info.ProveedorA<BR>Info.FechaD<BR>Info.FechaA
CarpetaVisible=S
[Acciones.Cerrar]
Nombre=Cerrar
Boton=23
