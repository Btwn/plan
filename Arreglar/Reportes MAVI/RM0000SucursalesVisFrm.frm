...
BusquedaAncho=20
BusquedaEnLinea=S
IconosNombre=RM0000SucursalesVis:Num
[Vista.Columnas]
0=53
1=143
Sucursal=100
...
Activo=S
Visible=S
Expresion=asigna(Mavi.SucursalRHSuc,SQL(<T>Exec SP_MaviCuentaEstacionUEN <T>+EstacionTrabajo+<T>,2<T>))<BR>SQL(<T>Exec SP_MaviCuentaEstacionUEN <T>+EstacionTrabajo+<T>,2<T>)
