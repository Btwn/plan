[Forma]
Clave=RM0755CategoCanalVtaVisFrm
Nombre=Categoria Canal Vta
Icono=95
Modulos=(Todos)
...
IconosSubTitulo=<T>Categoria Canal Vta<T>
IconosSeleccionMultiple=S
MenuLocal=S
ListaAcciones=SelAll<BR>QuitaSel
IconosNombre=RM0755CategoCanalVtaVis:Categoria
[Vista.Columnas]
Tipo=304
