[Forma]
Clave=RM0402RelRecFacYNotVenFrm
Nombre=RM0402 Relación de Recepción de Facturas y/o Notas de Venta
Icono=370
Modulos=(Todos)
...
ExpresionesAlMostrar=Asigna(Mavi.RM0399Sucursal,Nulo)<BR>Asigna(Info.FechaA,Nulo)<BR>Asigna(Info.FechaD,Nulo)
[(Variables)]
Estilo=Ficha
Clave=(Variables)
...
ListaEnCaptura=Mavi.RM0399Sucursal<BR>Info.FechaD<BR>Info.FechaA
[Acciones.Cerrar]
Nombre=Cerrar
Boton=23
NombreEnBoton=S
