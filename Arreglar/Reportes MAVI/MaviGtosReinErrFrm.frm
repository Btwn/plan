...
EjecucionMensaje=Si ((Info.FechaA)<(Info.FechaD)) o ((Mavi.FechaF)<(Mavi.FechaI))<BR>    Entonces <T>La Fecha Final debe ser Mayor o Igual que la Inicial<T><BR>Fin<BR>//Si ((Mavi.FechaF)<(Mavi.FechaI))<BR>//ENTONCES <T>La Fecha Final debe ser Mayor o Igual que la Inicial<T><BR>//Fin
