[Forma]
Clave=RM0755EAnalisisDeCarteraASCIIFrm
Icono=90
Modulos=(Todos)
...
PosicionSec2=328
PosicionCol2=281
Nombre=RM0755E Análisis de Cartera ASCII
VentanaRepetir=S
PosicionCol3=282
VentanaAjustarZonas=S

ExpresionesAlMostrar=asigna(Mavi.XV1,0)<BR>asigna(Mavi.XV2,0)<BR>asigna(Mavi.XV3,0)<BR>asigna(Mavi.DV1,0)<BR>asigna(Mavi.DV2,0)<BR>asigna(Mavi.DV3,0)<BR>asigna(Mavi.DV4,0)<BR>asigna(Mavi.DV5,0)<BR>Asigna(Mavi.RM0755ECategoriaCanal,<T><T>)
...
CampoColorLetras=Negro
CampoColorFondo=Blanco
ListaEnCaptura=Mavi.DiaPorVencer<BR>Mavi.XV1<BR>Mavi.XV2<BR>Mavi.XV3<BR>Mavi.RM0755ECategoriaCanal
CarpetaVisible=S
ConFuenteEspecial=S
...
[XV.Mavi.RM0755ECategoriaCanal]
Carpeta=XV
Clave=Mavi.RM0755ECategoriaCanal
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
