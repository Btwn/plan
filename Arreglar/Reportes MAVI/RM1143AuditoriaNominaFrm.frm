[Forma]
Clave=RM1143AuditoriaNominaFrm
Nombre=Auditoria Nomina
Icono=515
Modulos=(Todos)
...
Visible=S
Multiple=S
ListaAccionesMultiples=Asignar<BR>txt<BR>txt2<BR>Cerrar
EspacioPrevio=S
...
ClaveAccion=RM1143NominaReglaContableRepTxt
Activo=S
Visible=S
[Acciones.Txt.Cerrar]
Nombre=Cerrar
...
Boton=0
TipoAccion=Reportes Impresora
ClaveAccion=RM1143NominaReglaRSARepTxt
Activo=S
Visible=S
