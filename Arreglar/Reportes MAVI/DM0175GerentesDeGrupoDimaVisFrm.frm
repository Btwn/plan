[Forma]
Clave=DM0175GerentesDeGrupoDimaVisFrm
Nombre=DM0175 Gerentes Grupo Dima
Icono=0
Modulos=(Todos)
...
Zona=A1
Vista=DM0175GerentesDeGrupoDimaVis
...
IconosNombre=DM0175GerentesDeGrupoDimaVis:Nombre
[Agentes.Columnas]
0=20
1=66
Agente=64
...
Expresion=Asigna(Mavi.DM0175GerentesDima,SQL(<T>Exec SP_MaviCuentaEstacionUEN <T>+EstacionTrabajo+<T>,1<T>))<BR>SQL(<T>Exec SP_MaviCuentaEstacionUEN <T>+EstacionTrabajo+<T>,1<T>)
Activo=S
Visible=S
