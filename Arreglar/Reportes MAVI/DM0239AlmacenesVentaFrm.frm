...
Activo=S
Visible=S
Expresion=Asigna(Mavi.DM0239AlmacenVenta,SQL(<T>Exec SP_MaviCuentaEstacionUEN <T>+EstacionTrabajo+<T>,2<T>))<BR>SQL(<T>Exec SP_MaviCuentaEstacionUEN <T>+EstacionTrabajo+<T>,2<T>)
...
FiltroGrupo2=Nombre
IconosNombre=DM0239AlmacenesVentaVis:Almacen
[Vista.Nombre]
Carpeta=Vista
Clave=Nombre
Editar=S
