...
BusquedaRapida=S
BusquedaEnLinea=S
IconosNombre=RM0000PuestosVis:puesto
[Vista.Columnas]
Puesto=82
Descripcion=350
0=-2
...
Activo=S
Visible=S
Expresion=Asigna(Mavi.PuestoSuc,SQL(<T>Exec SP_MaviCuentaEstacionUEN <T>+EstacionTrabajo+<T>,2<T>))<BR>SQL(<T>Exec SP_MaviCuentaEstacionUEN <T>+EstacionTrabajo+<T>,1<T>)
