...
BusquedaAncho=20
BusquedaEnLinea=S
IconosNombre=RM1158SucursalVis:Sucursal
[Vista.Columnas]
0=-2
1=203
NombreSucursal=604
...
Activo=S
Visible=S
Expresion=Asigna(Mavi.RM1158Sucursal,SQL(<T>Exec SP_MaviCuentaEstacionUEN <T>+EstacionTrabajo+<T>,1<T>))<BR>SQL(<T>Exec SP_MaviCuentaEstacionUEN <T>+EstacionTrabajo+<T>,1<T>)
