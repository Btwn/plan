[Forma]
Clave=RM0474GtosConcMagViaticosFrm
Nombre=RM0474 Concentrado Magisterio
Icono=0
Modulos=(Todos)
MovModulo=GAS
...
VentanaEscCerrar=S
ExpresionesAlMostrar=Asigna(Info.FechaD,nulo)<BR>Asigna(Info.FechaA,nulo)<BR>Asigna(Mavi.CentroCosto,nulo)
[Variables]
Estilo=Ficha
Clave=Variables
...
ListaEnCaptura=Info.FechaD<BR>Info.FechaA<BR>Mavi.CentroCosto
CarpetaVisible=S
PermiteEditar=S
FichaNombres=Arriba
...
EjecucionConError=S
Visible=S
[Variables.Mavi.CentroCosto]
Carpeta=Variables
Clave=Mavi.CentroCosto
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
