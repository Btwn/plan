...
ListaCarpetas=Ficha<BR>Precios<BR>Accesorios<BR>Refacciones<BR>Servicios<BR>Consumibles<BR>Sustitutos<BR>Costos<BR>ArtCosto<BR>SubCostos<BR>FormaExtraValor<BR>ArtDisponible<BR>ArtPartidaAsignado<BR>ArtReservado<BR>ArtPartida<BR>Presupuesto<BR>Lista
...
AccionesDerecha=S
ListaAcciones=Aceptar<BR>Propiedades<BR>Evaluaciones<BR>Anexos<BR>Doc<BR>Politica<BR>PrecioHist<BR>ArtCostoHist<BR>ArtSubCostoHist<BR>ArtAlmInfo<BR>Plan<BR>Cubos<BR>Sustitutos<BR>Desglose<BR>Opciones<BR>ArtSerie<BR>Partidas<BR>Reservados<BR>CompraPendiente<BR>VentaPendiente<BR>SolicitudPendiente<BR>PorProcesar<BR>ArtPosicionExistencia<BR>Capas<BR>CapasUEPS<BR>CapasPEPS<BR>SerieLoteCosto<BR>ArtConsignacion<BR>ArtProvInfo<BR>ExplorarVentaD<BR>VentasAcum<BR>ExplorarInv<BR>ComprasAcum<BR>Cerrar
AccionesDivision=S
VentanaExclusiva=S
Menus=S
VentanaEscCerrar=S
...
ListaEnCaptura=Art.Descripcion1<BR>Art.Descripcion2<BR>Art.Tipo<BR>EstatusNombre<BR>Art.PrecioLista<BR>Art.MonedaPrecio<BR>Art.Categoria<BR>Art.Grupo<BR>Art.Familia<BR>Art.Linea<BR>Art.Fabricante<BR>Art.ClaveFabricante<BR>Art.Unidad<BR>Art.Peso<BR>Art.Volumen<BR>Art.Impuesto1<BR>Art.Impuesto2<BR>Art.Impuesto3
CarpetaVisible=S
PestanaOtroNombre=S
...
CampoColorLetras=Negro
CampoColorFondo=Plata
ListaEnCaptura=ArtCostoEmpresa.UltimoCosto<BR>ArtCostoEmpresa.CostoPromedio<BR>Art.CostoEstandar<BR>Art.CostoReposicion<BR>Art.MonedaCosto
Filtros=S
FiltroTipo=General
FiltroEnOrden=S
FiltroTodoNombre=Todo
...
CampoColorLetras=Negro
CampoColorFondo=Blanco
ListaEnCaptura=ArtAccesorio.Accesorio<BR>Art.Descripcion1
FiltroTipo=General
FiltroEnOrden=S
FiltroTodoNombre=Todo
FiltroNullNombre=(sin clasificar)
...
FiltroPredefinido=S
ValidarCampos=S
ListaCamposAValidar=Art.PrecioLista<BR>Art.MonedaPrecio
...
CampoColorLetras=Negro
CampoColorFondo=Blanco
ListaEnCaptura=ArtRefaccion.Refaccion<BR>Art.Descripcion1<BR>ArtRefaccion.Cantidad
Filtros=S
FiltroPredefinido=S
FiltroAncho=30
FiltroEnOrden=S
...
CampoColorLetras=Negro
CampoColorFondo=Blanco
ListaEnCaptura=ArtPartida.SubCuenta<BR>SubCuentaDesc<BR>ArtPartida.Existencia<BR>ArtPartida.ExistenciaAlterna<BR>ArtPartida.Almacen
Filtros=S
FiltroPredefinido=S
FiltroAncho=15
FiltroEnOrden=S
...
CampoColorLetras=Negro
CampoColorFondo=Blanco
ListaEnCaptura=ArtSustituto.Sustituto<BR>Art.Descripcion1
ListaCamposAValidar=Art.PrecioLista<BR>ArtSustituto.Comentarios
...
CampoColorLetras=Negro
CampoColorFondo=Blanco
ListaEnCaptura=Cliente<BR>Nombre<BR>Existencia<BR>ExistenciaAlterna<BR>Almacen
FiltroPredefinido=S
FiltroNullNombre=(sin clasificar)
FiltroEnOrden=S
FiltroTodoNombre=Todo
...
CampoColorLetras=Negro
CampoColorFondo=Plata
ListaEnCaptura=Art.PrecioLista<BR>Art.Precio2<BR>Art.Precio3<BR>Art.Precio4<BR>Art.Precio5<BR>Art.Precio6<BR>Art.Precio7<BR>Art.Precio8<BR>Art.Precio9<BR>Art.Precio10<BR>Art.PrecioMinimo
...
CampoColorLetras=Negro
CampoColorFondo=Blanco
ListaEnCaptura=ArtSubCosto.UltimoCosto<BR>ArtSubCosto.CostoPromedio<BR>Art.MonedaCosto
Filtros=S
FiltroPredefinido=S
FiltroNullNombre=(sin clasificar)
FiltroEnOrden=S
...
FiltroTipo=General
MenuLocal=S
ListaAcciones=VerOpcion<BR>SubCostoCampos
...
CampoColorLetras=Negro
CampoColorFondo=Blanco
ListaEnCaptura=ArtServicio.Servicio<BR>Art.Descripcion1<BR>ArtServicio.Cantidad
Filtros=S
FiltroPredefinido=S
FiltroNullNombre=(sin clasificar)
FiltroEnOrden=S
...
CampoColorLetras=Negro
CampoColorFondo=Blanco
ListaEnCaptura=ArtConsumible.Consumible<BR>Art.Descripcion1<BR>ArtConsumible.Cantidad
Filtros=S
FiltroPredefinido=S
FiltroNullNombre=(sin clasificar)
FiltroEnOrden=S
...
CampoColorLetras=Negro
CampoColorFondo=Blanco
ListaEnCaptura=ArtCosto.CostoPromedio<BR>ArtCosto.UltimoCosto
Filtros=S
BusquedaRapidaControles=S
FiltroPredefinido=S
FiltroNullNombre=(sin clasificar)
...
CampoColorLetras=Negro
CampoColorFondo=Blanco
ListaEnCaptura=Presupuesto.Periodo<BR>Presupuesto.Presupuesto<BR>Presupuesto.Reservado<BR>Presupuesto.Ejercido<BR>Disponible
FiltroPredefinido=S
FiltroNullNombre=(sin clasificar)
FiltroEnOrden=S
FiltroTodoNombre=(Todo)
...
FiltroRespetar=S
FiltroTipo=General
ListaEnCaptura=PropreLista.Lista<BR>PropreLista.Descripcion<BR>PropreListaD.Margen<BR>PropreLista.UEN
HojaTitulos=S
...
FiltroGeneral=PropreListaD.Articulo =  <T>{Info.Articulo}<T>
