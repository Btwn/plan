[Forma]
Clave=RM0946BNiveldeCobranzaVisFrm
Nombre=Nivel de Cobranza
Icono=0
Modulos=(Todos)
ListaCarpetas=RM0946BNiveldeCobranzaVis
CarpetaPrincipal=RM0946BNiveldeCobranzaVis
...
Activo=S
Visible=S
Expresion=asigna(Mavi.RM0946Bncobranza,SQL(<T>Exec SP_MaviCuentaEstacionUEN <T>+EstacionTrabajo+<T>,1<T>))<BR>SQL(<T>EXEC dbo.SP_MaviCuentaEstacionUEN :nEst, 1<T>,EstacionTrabajo)
[Acciones.cerrar]
Nombre=cerrar
Boton=36
NombreEnBoton=S
...
Activo=S
Visible=S
[RM0946BNiveldeCobranzaVis]
Estilo=Iconos
Clave=RM0946BNiveldeCobranzaVis
AlineacionAutomatica=S
AcomodarTexto=S
Zona=A1
Vista=RM0946BNiveldeCobranzaVis
...
CarpetaVisible=S
IconosNombre=RM0946BNiveldeCobranzaVis:nivelcobranza
[RM0946BNiveldeCobranzaVis.Columnas]
0=-2
