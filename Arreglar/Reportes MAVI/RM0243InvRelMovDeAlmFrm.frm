[Forma]
Clave=RM0243InvRelMovDeAlmFrm
Nombre=RM243 Relación de Movimientos de Almacén      
Icono=370
Modulos=(Todos)
...
ExpresionesAlMostrar=Asigna(Info.Fecha,Hoy)<BR>Asigna(Info.FechaD,Nulo)<BR>Asigna(Info.FechaA,Nulo))
[(Variables)]
Estilo=Ficha
Clave=(Variables)
PermiteEditar=S
