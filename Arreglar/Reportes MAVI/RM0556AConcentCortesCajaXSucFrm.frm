[Forma]
Clave=RM0556AConcentCortesCajaXSucFrm
Nombre=RM0556A Concentrado de Cortes de Caja Por Sucursal
Icono=126
Modulos=(Todos)
...
VentanaEscCerrar=S
VentanaAvanzaTab=S
ExpresionesAlMostrar=Asigna(Mavi.RM0556ASucursalD,Nulo)<BR>Asigna(Mavi.RM0556ASucursalA,Nulo)<BR>//Asigna(Info.Sucursal,Nulo)<BR>Asigna(Info.FechaD,Nulo)<BR>Asigna(Info.FechaA,Nulo)<BR>//Asigna(Mavi.caracter1,Nulo)<BR>//Asigna(Mavi.caracter2,Nulo)<BR>//Asigna(Mavi.caracteres,Nulo)
[(Variables)]
Estilo=Ficha
Clave=(Variables)
PermiteEditar=S
...
ListaEnCaptura=Mavi.RM0556ASucursalD<BR>Mavi.RM0556ASucursalA<BR>Info.FechaD<BR>Info.FechaA
CarpetaVisible=S
...
Activo=S
Visible=S
[(Variables).Mavi.RM0556ASucursalD]
Carpeta=(Variables)
Clave=Mavi.RM0556ASucursalD
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
ColorFondo=Blanco
ColorFuente=Negro
[(Variables).Mavi.RM0556ASucursalA]
Carpeta=(Variables)
Clave=Mavi.RM0556ASucursalA
Editar=S
ValidaNombre=S
3D=S
Tamano=25
