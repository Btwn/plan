[Forma]
Clave=RM0267CalPrimaSegVtaTranspFrm
Nombre=RM0267 Cálculo de Prima de Seguros de Venta Transportado
Icono=572
Modulos=(Todos)
...
CarpetaVisible=S
ListaEnCaptura=Info.FechaD<BR>Info.FechaA<BR>Mavi.RM0267Factor<BR>Mavi.RM0267LineadeArts
[Acciones.Preliminar]
Nombre=Preliminar
Boton=6
NombreEnBoton=S
...
ColorFuente=Negro
Efectos=[Negritas]
[(Variables).Mavi.RM0267Factor]
Carpeta=(Variables)
Clave=Mavi.RM0267Factor
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
ColorFuente=Negro
Efectos=[Negritas]
[(Variables).Mavi.RM0267LineadeArts]
Carpeta=(Variables)
Clave=Mavi.RM0267LineadeArts
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
