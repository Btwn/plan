[Forma]
Clave=MaviGtosEstActuFacGtosFrm
Nombre=RM479 Situación Actual Facturas de Gastos
Icono=0
Modulos=(Todos)
...
ListaEnCaptura=Info.AcreedorD<BR>Info.AcreedorA<BR>Info.ProvCat<BR>Info.ProvFam<BR>Info.Sucursal<BR>Info.UEN<BR>Info.MovClaveAfecta<BR>Info.Moneda<BR>Info.Estatus<BR>Info.FechaD<BR>Info.FechaA<BR>Mavi.TexFvenciEmi
CarpetaVisible=S
