...
ExpresionesAlMostrar=Asigna(Info.ProveedorD,nulo)<BR>Asigna(Mavi.OrdenesPorProv,nulo)<BR>Asigna(Mavi.ArtPorOrdenProv,nulo)<BR>Asigna(Mavi.FacturaoRemision,nulo)<BR>Asigna(Mavi.Transporte,nulo)<BR>Asigna(Mavi.PlacasyTipoCarga,nulo)<BR>Asigna(Mavi.NombreChofer,nulo)<BR>Asigna(Mavi.ObservacionRM,nulo)
[(Variables)]
Estilo=Ficha
Clave=(Variables)
...
ListaEnCaptura=Info.ProveedorD<BR>Mavi.OrdenesPorProv<BR>Mavi.ArtPorOrdenProv<BR>Mavi.FacturaoRemision<BR>Mavi.Transporte<BR>Mavi.PlacasyTipoCarga<BR>Mavi.NombreChofer<BR>Mavi.ObservacionRM
CarpetaVisible=S
PermiteEditar=S
...
EjecucionConError=S
Visible=S
EjecucionCondicion=ConDatos(Info.ProveedorD)Y ConDatos(Mavi.OrdenesPorProv) Y ConDatos(Mavi.ArtPorOrdenProv)
...
Visible=S
NombreEnBoton=S
[(Variables).Mavi.ArtPorOrdenProv]
Carpeta=(Variables)
Clave=Mavi.ArtPorOrdenProv
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
