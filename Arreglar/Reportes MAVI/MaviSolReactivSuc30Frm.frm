[Forma]
Clave=MaviSolReactivSuc30Frm
Nombre=RM410 Solicitudes Reactivadas. Sucursal 30
Icono=0
Modulos=(Todos)
...
VentanaAvanzaTab=S
ExpresionesAlMostrar=Asigna(Mavi.FechaEmision,Hoy)<BR>Asigna(Info.FechaD,Nulo)<BR>Asigna(Info.FechaA,Nulo)
[(Variables)]
Estilo=Ficha
Clave=(Variables)
