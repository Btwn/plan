[Forma]
Clave=MaviSubGerAdminCobSegVidaFrm
Nombre=RM283 Cobros de Seguros de Vida
Icono=573
BarraHerramientas=S
Modulos=(Todos)
...
ExpresionesAlMostrar=ASIGNA(Mavi.SeguroVIDA,<T><T>)<BR>asigna(Info.FechaD, Nulo)<BR>asigna(Info.FechaA, Nulo)
[(Variables)]
Estilo=Ficha
Clave=(Variables)
PermiteEditar=S
